...
const SkillsSection = ({ skills }) => {
  return (
    <div className="flex flex-col items-center">
      {/* Align Programming Languages and Frameworks/Libraries side by side */}
      <div className="flex flex-row justify-center w-full">
        <SkillCard title="Programming Languages" items={skills[0].items} />
        <SkillCard title="Frameworks/Libraries" items={skills[1].items} />
      </div>
      {/* Center Tools section below */}
      <div className="flex justify-center w-full mt-6">
        <SkillCard title="Tools" items={skills[2].items} />
      </div>
    </div>
  );
};
